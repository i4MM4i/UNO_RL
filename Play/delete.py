...
def states():
    ...
    for i in range(len(states)):
        if (states[i][1] >= states[i][10]) and (states[i][2] >= states[i][11]) and (states[i][3] >= states[i][12]) and (
                states[i][4] >= states[i][13]) and (states[i][5] >= states[i][14]) and (
                states[i][6] >= states[i][15]) and (states[i][7] >= states[i][16]):
